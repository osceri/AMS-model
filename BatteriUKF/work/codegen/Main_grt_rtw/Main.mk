...
## 
## Makefile     : Main.mk
## Generated on : Sat Mar 12 20:14:36 2022
...
DEFINES_STANDARD = -DMODEL=Main -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/Main_grt_rtw/Main.c $(START_DIR)/Main_grt_rtw/Main_data.c
...
OBJS = rt_logging.obj Main.obj Main_data.obj
...
%.obj : $(START_DIR)/Main_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
