...
DEFINES_STANDARD = -DMODEL=Accumulator -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\Accumulator_ert_rtw\Accumulator.c $(START_DIR)\Accumulator_ert_rtw\Accumulator_data.c

MAIN_SRC = $(START_DIR)\Accumulator_ert_rtw\ert_main.c
...
OBJS = Accumulator.obj Accumulator_data.obj
...
{$(START_DIR)\Accumulator_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Accumulator_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Accumulator.obj : "$(START_DIR)\Accumulator_ert_rtw\Accumulator.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Accumulator_ert_rtw\Accumulator.c"


Accumulator_data.obj : "$(START_DIR)\Accumulator_ert_rtw\Accumulator_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Accumulator_ert_rtw\Accumulator_data.c"


ert_main.obj : "$(START_DIR)\Accumulator_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Accumulator_ert_rtw\ert_main.c"
