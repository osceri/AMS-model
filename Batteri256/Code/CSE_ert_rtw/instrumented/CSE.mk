###########################################################################
## Makefile generated for component 'CSE'. 
## 
## Makefile     : CSE.mk
## Generated on : Tue Apr 12 04:35:51 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\CSE.exe
...
COMPILER_COMMAND_FILE     = CSE_comp.rsp
CMD_FILE                  = CSE.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\CSE.exe
...
DEFINES_STANDARD = -DMODEL=CSE -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\CSE_ert_rtw\CSE.c $(START_DIR)\CSE_ert_rtw\CSE_data.c

MAIN_SRC = $(START_DIR)\CSE_ert_rtw\ert_main.c
...
{$(START_DIR)\CSE_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\CSE_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
CSE.obj : "$(START_DIR)\CSE_ert_rtw\CSE.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\CSE_ert_rtw\CSE.c"


CSE_data.obj : "$(START_DIR)\CSE_ert_rtw\CSE_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\CSE_ert_rtw\CSE_data.c"


ert_main.obj : "$(START_DIR)\CSE_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\CSE_ert_rtw\ert_main.c"
