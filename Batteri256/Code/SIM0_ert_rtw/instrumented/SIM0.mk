...
COMPILER_COMMAND_FILE     = SIM0_comp.rsp
CMD_FILE                  = SIM0.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\SIM0.exe
...
DEFINES_STANDARD = -DMODEL=SIM0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
{$(START_DIR)\SIM0_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SIM0_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
SIM0_data.obj : "$(START_DIR)\SIM0_ert_rtw\SIM0_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\SIM0_ert_rtw\SIM0_data.c"
