...
## 
## Makefile     : CBR.mk
## Generated on : Sat Apr 09 14:30:58 2022
...
DEFINES_STANDARD = -DMODEL=CBR -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\CBR_ert_rtw\CBR.c $(START_DIR)\CBR_ert_rtw\CBR_data.c

MAIN_SRC = $(START_DIR)\CBR_ert_rtw\ert_main.c
...
{$(START_DIR)\CBR_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\CBR_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
CBR.obj : "$(START_DIR)\CBR_ert_rtw\CBR.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\CBR_ert_rtw\CBR.c"


CBR_data.obj : "$(START_DIR)\CBR_ert_rtw\CBR_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\CBR_ert_rtw\CBR_data.c"


ert_main.obj : "$(START_DIR)\CBR_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\CBR_ert_rtw\ert_main.c"
